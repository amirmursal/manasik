...
const SearchPanel = () => {
  return (
    <Box sx={searchPanelStyles.root}>
      <Typography variant="h6" sx={searchPanelStyles.infoText} component="div">
        Find the Best & Reliable HAJJ and UMRAH Tours in India
      </Typography>
      <Box sx={searchPanelStyles.container}>
        <Grid
          container
          spacing={2}
          columns={{ xs: 1, sm: 8, md: 12 }}
          sx={searchPanelStyles.searchForm}
        >
          <Grid item xs={3}>
