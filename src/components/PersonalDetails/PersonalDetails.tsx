...
const PersonalDetails = () => {
  return (
    <Box sx={personalDetailsStyles.root}>
      <Typography variant="h4" component="div" sx={personalDetailsStyles.head}>
        Agent Module
      </Typography>
      ...
      <Typography
        variant="h6"
        component="div"
        sx={personalDetailsStyles.subHead}
      >
        Personal Details
      </Typography>
      ...
      >
        <Grid
          ...
          columnSpacing={{ xs: 1, sm: 12, md: 12 }}
        >
          <Grid item xs={6} sx={personalDetailsStyles.input}>
            <Typography sx={personalDetailsStyles.lable}>
              Agency Name
            </Typography>
            <TextField
              type="text"
        ...
        <Grid marginTop="5%" marginBottom="1%">
          <Button href="/addAgentBankDetails" variant="contained">
            Next Page
          </Button>
        </Grid>
      </Box>
