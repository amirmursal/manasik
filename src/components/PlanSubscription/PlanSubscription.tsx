          ...
          >
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>50</td>
                  <td><Checkbox defaultChecked color="success" />5000</td>
                  <td><Checkbox defaultChecked color="success" />10000</td>
                  <td><Checkbox defaultChecked color="success" />15000</td>
                  <td><Checkbox defaultChecked color="success" />22500</td>
                </tr>
                <tr>
                  <td>100</td>
                  <td><Checkbox defaultChecked color="success" />47500</td>
                  <td><Checkbox defaultChecked color="success" />15000</td>
                  <td><Checkbox defaultChecked color="success" />22500</td>
                  <td><Checkbox defaultChecked color="success" />33750</td>
                </tr>
                <tr>
                  <td>5000</td>
                  <td><Checkbox defaultChecked color="success" />16875</td>
                  <td><Checkbox defaultChecked color="success" />33750</td>
                  <td><Checkbox defaultChecked color="success" />50625</td>
                  <td><Checkbox defaultChecked color="success" />75938</td>
                </tr>
              </tbody>
            </table>
          </Box>
