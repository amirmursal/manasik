...
const ManagePackage = () => {
    return (
      <Box sx={ManagePackageStyles.root}>
        <Typography variant="h4" component="div" sx={ManagePackageStyles.head}>Manage Package</Typography>
  
        <Divider sx={ManagePackageStyles.divider} />
  
        <Typography variant="h6" component="div" sx={ManagePackageStyles.preSubHead} >UMRAH 30-SEP-2023</Typography>
        <Typography variant="h6" component="div" sx={ManagePackageStyles.subHead} >Add Package</Typography>
  
        <Box  sx={ManagePackageStyles.program}>
                  <Grid container rowSpacing={{xs:2}} columns={{xs:1, sm:4, md:12}}>
